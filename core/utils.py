...
def draw_bbox(image, bboxes, classes=read_class_names(cfg.YOLO.CLASSES), show_label=True):
    ...
    for i in range(num_boxes[0]):
        ...
        ## TODO: crop license plate images 
        #if classes[class_ind] == 'license_plate':
        #    print(classes[class_ind], c1, c2)
        #    cropped_img = image[int(c1[1]): int(c2[1]), int(c1[0]): int(c2[0])]
        #    cv2.imwrite('cropped{}.jpg'.format(crop_index), cropped_img)
        #    crop_index += 1
